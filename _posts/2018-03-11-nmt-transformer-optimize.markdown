...
The results below shows that TVM generated kernel(with schdule optimization) brings at least <b>*13X*</b> speed-up for batch matmul computation. The kernel fusion optimization brings further <b>*1.7X*</b> speed-up.
